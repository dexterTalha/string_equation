...
void main() {
  group('A group of tests', () {
    test("Solve Expression0", () async {
      bool value = ConditionEquation().evaluateExpression("((0.00==1)||((180.00>=180)&&(180.00<=400)&&(1.00<=300))||((1.00>=110)&&(1.00<=300)&&(180.00<=400)))");
      expect(true, value);
    });
    test("Solve Expression1", () async {
      bool value = ConditionEquation().solveExpression("((0.00==1)||(180.00>=180)&&(180.00<=400)&&(1.00<=300)||(1.00>=110)&&(1.00<=300)&&(180.00<=400))");
      expect(true, value);
    });
    ...
    test("EXT", () async {
      var value = ConditionEquation(answerMap: {
        "order30": ["c70c7c93-f486-43a7-bff6-9e82ec849885", "deb0118f-85c3-47c9-81b2-ed1b9b595224", "8279398a-ff02-4c08-84df-e755611ca017", "4c8e76bb-869a-4f85-9892-5c1c6341e922"]
    ...
    test("Check date type expr", () async {
      var value = ConditionEquation(answerMap: {"order257": "27-11-2024"}).evaluateExpression("(\$today  > (order257 + 30))");

      expect(false, value);
    });

    test("Check date type expr 2", () async {
      var value = ConditionEquation(answerMap: {"order29": "18-09-2024", "date_pl": "27-09-2024"}).evaluateExpression("((\$today < (order29+210)) && (\$today < (date_pl+90)))");
